...
cause_checker3 = cc.CauseChecker(timed_automaton, trace, ts.DelayCause([], [("tau_1!", 1), ("tau_1!", 2), ("tau_1!", 3)]))
cause_checker4 = cc.CauseChecker(timed_automaton, trace, ts.DelayCause([(1, 1), (8, 3)], [("tau_1!", 2), ("tau_1!", 3)]))
...
res = "Runtime Results Fischer, Trace 1, Sample Size: " + str(sample_size)
...
with open("src\\Experimenter_Scripts\\Fischer_Results_Trace1.txt", "w") as file:
    file.write(res)
